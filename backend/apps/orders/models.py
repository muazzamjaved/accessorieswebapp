...
class Order(models.Model):
    ...
    address_line1 = models.CharField(
        'Address Line1', blank= False , null=False, max_length=25, db_index=True
    )
    address_line2 = models.CharField(
        'Address Line2', blank=False, null=False, max_length= 25, db_index=True
    )
    ...
    country= models.CharField(
        'Country', blank=False, null=False, max_length=25 , db_index=True, default='United States', choices=COUNTRIES
    )
